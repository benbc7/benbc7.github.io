		...
		return (
			<div className="row">
				<div className="col-md-4 mb-3 mb-md-0">
					<div className="card py-4 h-100" style={{ backgroundImage: 'url("/images/card-left.jpg")', backgroundPosition: 'center', backgroundSize: 'cover' }}>
				...
				<div className="col-md-4 mb-3 mb-md-0">
					<div className="card py-4 h-100" style={{ backgroundImage: 'url("/images/card-center.jpg")', backgroundPosition: 'center', backgroundSize: 'cover' }}>
						<div className="card-body text-center">
				...
				<div className="col-md-4 mb-3 mb-md-0">
					<div className="card py-4 h-100" style={{ backgroundImage: 'url("/images/card-right.jpg")', backgroundPosition: 'center', backgroundSize: 'cover' }}>
						<div className="card-body text-center">
